...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the wwwcoin database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with Wwwcore Node configuration')
    .option('-d, --daemon', 'Make wwwcore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `wwwcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ wwwcore-node add wallet-service');
      console.log('    $ wwwcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ wwwcore-node remove wallet-service');
      console.log('    $ wwwcore-node remove insight-api');
      console.log();
    });
