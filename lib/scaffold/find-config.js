...
/**
 * Will return the path and wwwcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'wwwcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'wwwcore-node.json'))
  };
}
